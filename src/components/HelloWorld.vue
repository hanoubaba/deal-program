  ...
  methods: {
    getResult1() {
      ...
      if (parseFloat(this.startNum) < parseFloat(this.endNum)) {
        ...
        // 反向波动率
        let num3 =
          "-" + (((num1 * this.eatNum) / this.endNum) * 100).toFixed(2) + "%";
        // 指导价格
        let len = 0;
        ...
        let num4 = (
          parseFloat(this.endNum) - parseFloat(num1 * this.eatNum)
        ).toFixed(len);
        // 追求翻倍收益的杠杆倍数
    ...
    getResult2() {
      ...
      if (parseFloat(this.startNum) < parseFloat(this.endNum)) {
        ...
        this.profitPer =
          (
            ((newNum - this.stopProfitPrice) / newNum) *
            100 *
            this.resLeverage
          ).toFixed(2) + "%";
        // 预计亏损
        ...
        this.profitLoss =
          (
            ((newNum - this.stopProfitPrice) / (this.stopLoss - newNum)) *
            100
          ).toFixed(2) + "%";
      }
      // 反向做多策略
      if (parseFloat(this.startNum) > parseFloat(this.endNum)) {
        ...
        this.profitPer =
          (
            ((this.stopProfitPrice - newNum) / newNum) *
            100 *
            this.resLeverage
          ).toFixed(2) + "%";
        // 预计亏损
